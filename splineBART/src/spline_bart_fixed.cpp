...
// [[Rcpp::export]]
Rcpp::List spline_bart_fixed(Rcpp::List Y_train,
                             Rcpp::List Phi_train,
                             arma::mat Z_train,
                             arma::mat Z_test,
                             Rcpp::List cutpoints,
                             double alpha, double beta,
                             arma::mat K, double log_det_K, size_t K_ord,
                             double tau, // Do not scale by sqrt(M) in input, that is done internally.
                             ...
                             bool verbose, size_t print_every, bool debug = false)
{
  ...
  if(verbose) Rcpp::Rcout << "[splineBART]: Entering splineBART" << std::endl;
